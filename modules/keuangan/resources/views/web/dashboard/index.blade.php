...
<div class="flex min-h-screen relative">
    ...
    <main class="flex-1 px-6 py-6 lg:px-8 lg:py-7 overflow-x-hidden lg:ml-64">
        ...
        <header class="flex items-center justify-between mb-7">
            ...
            <a href="{{ route('wallets.resume') }}" target="_blank" class="hidden sm:flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-xl text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#386650] focus:ring-offset-2 transition-all">
                <svg class="w-5 h-5 text-[#386650]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
